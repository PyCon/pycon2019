...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FinancialAidEmailTemplate'
        db.create_table(u'finaid_financialaidemailtemplate', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=80)),
            ('template', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'finaid', ['FinancialAidEmailTemplate'])


    def backwards(self, orm):
        # Deleting model 'FinancialAidEmailTemplate'
        db.delete_table(u'finaid_financialaidemailtemplate')
