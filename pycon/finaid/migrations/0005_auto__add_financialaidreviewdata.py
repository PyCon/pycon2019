...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FinancialAidReviewData'
        db.create_table(u'finaid_financialaidreviewdata', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('application', self.gf('django.db.models.fields.related.OneToOneField')(related_name='review', unique=True, to=orm['finaid.FinancialAidApplication'])),
            ('status', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('hotel_amount', self.gf('django.db.models.fields.DecimalField')(default='0.00', max_digits=8, decimal_places=2)),
        ))
        db.send_create_signal(u'finaid', ['FinancialAidReviewData'])


    def backwards(self, orm):
        # Deleting model 'FinancialAidReviewData'
        db.delete_table(u'finaid_financialaidreviewdata')
