...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'FinancialAidReviewData.hotel_amount'
        db.delete_column(u'finaid_financialaidreviewdata', 'hotel_amount')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'FinancialAidReviewData.hotel_amount'
        db.add_column(u'finaid_financialaidreviewdata', 'hotel_amount',
                      self.gf('django.db.models.fields.DecimalField')(default='0.00', max_digits=8, decimal_places=2),
                      keep_default=False)
