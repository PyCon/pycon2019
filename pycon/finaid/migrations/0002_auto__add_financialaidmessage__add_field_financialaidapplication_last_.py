...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FinancialAidMessage'
        db.create_table(u'finaid_financialaidmessage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('application', self.gf('django.db.models.fields.related.ForeignKey')(related_name='messages', to=orm['finaid.FinancialAidApplication'])),
        ...
        db.send_create_signal(u'finaid', ['FinancialAidMessage'])

        # Adding field 'FinancialAidApplication.last_update'
        db.add_column(u'finaid_financialaidapplication', 'last_update',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 7, 23, 0, 0), blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting model 'FinancialAidMessage'
        db.delete_table(u'finaid_financialaidmessage')

        # Deleting field 'FinancialAidApplication.last_update'
        db.delete_column(u'finaid_financialaidapplication', 'last_update')
