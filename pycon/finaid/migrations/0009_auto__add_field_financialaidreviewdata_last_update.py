...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FinancialAidReviewData.last_update'
        db.add_column(u'finaid_financialaidreviewdata', 'last_update',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 7, 30, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FinancialAidReviewData.last_update'
        db.delete_column(u'finaid_financialaidreviewdata', 'last_update')
