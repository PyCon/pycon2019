...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PyConPosterProposal.additional_requirements'
        db.add_column(u'pycon_pyconposterproposal', 'additional_requirements',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'PyConTalkProposal.additional_requirements'
        db.add_column(u'pycon_pycontalkproposal', 'additional_requirements',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'PyConTutorialProposal.additional_requirements'
        db.add_column(u'pycon_pycontutorialproposal', 'additional_requirements',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PyConPosterProposal.additional_requirements'
        db.delete_column(u'pycon_pyconposterproposal', 'additional_requirements')

        # Deleting field 'PyConTalkProposal.additional_requirements'
        db.delete_column(u'pycon_pycontalkproposal', 'additional_requirements')

        # Deleting field 'PyConTutorialProposal.additional_requirements'
        db.delete_column(u'pycon_pycontutorialproposal', 'additional_requirements')
