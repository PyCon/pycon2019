...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field registrants on 'PyConTutorialProposal'
        m2m_table_name = db.shorten_name(u'pycon_pycontutorialproposal_registrants')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('pycontutorialproposal', models.ForeignKey(orm[u'pycon.pycontutorialproposal'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ))
        db.create_unique(m2m_table_name, ['pycontutorialproposal_id', 'user_id'])


    def backwards(self, orm):
        # Removing M2M table for field registrants on 'PyConTutorialProposal'
        db.delete_table(db.shorten_name(u'pycon_pycontutorialproposal_registrants'))
