...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ThunderdomeGroup'
        db.create_table(u'pycon_thunderdomegroup', (
            ...
            ('decided', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'pycon', ['ThunderdomeGroup'])

        # Adding field 'PyConTalkProposal.thunderdome_group'
        db.add_column(u'pycon_pycontalkproposal', 'thunderdome_group',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name=u'talks', null=True, blank=True, to=orm['pycon.ThunderdomeGroup']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ThunderdomeGroup'
        db.delete_table(u'pycon_thunderdomegroup')

        # Deleting field 'PyConTalkProposal.thunderdome_group'
        db.delete_column(u'pycon_pycontalkproposal', 'thunderdome_group_id')
