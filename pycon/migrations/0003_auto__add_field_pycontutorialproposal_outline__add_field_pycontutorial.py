...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PyConTutorialProposal.outline'
        db.add_column(u'pycon_pycontutorialproposal', 'outline',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'PyConTutorialProposal.more_info'
        db.add_column(u'pycon_pycontutorialproposal', 'more_info',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PyConTutorialProposal.outline'
        db.delete_column(u'pycon_pycontutorialproposal', 'outline')

        # Deleting field 'PyConTutorialProposal.more_info'
        db.delete_column(u'pycon_pycontutorialproposal', 'more_info')
