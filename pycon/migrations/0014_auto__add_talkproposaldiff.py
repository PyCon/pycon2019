...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TalkProposalDiff'
        db.create_table(u'pycon_talkproposaldiff', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('talk', self.gf('django.db.models.fields.related.ForeignKey')(related_name='revisions', to=orm['pycon.PyConTalkProposal'])),
            ('revision_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('diffs_json', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal(u'pycon', ['TalkProposalDiff'])


    def backwards(self, orm):
        # Deleting model 'TalkProposalDiff'
        db.delete_table(u'pycon_talkproposaldiff')
    ...
    models = {
        ...
        u'pycon.pyconproposalcategory': {
            'Meta': {'ordering': "['name']", 'object_name': 'PyConProposalCategory'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50'})
        },
        ...
        u'pycon.talkproposaldiff': {
            'Meta': {'ordering': "['-revision_date']", 'object_name': 'TalkProposalDiff'},
            'diffs_json': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'revision_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'talk': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'revisions'", 'to': u"orm['pycon.PyConTalkProposal']"})
        },
