...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PyConTutorialProposal.registration_count'
        db.add_column(u'pycon_pycontutorialproposal', 'registration_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PyConTutorialProposal.registration_count'
        db.delete_column(u'pycon_pycontutorialproposal', 'registration_count')
    ...
    models = {
        ...
        u'pycon.pycontutorialproposal': {
            ...
            'registration_count': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'rejection_status': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'})
        },
