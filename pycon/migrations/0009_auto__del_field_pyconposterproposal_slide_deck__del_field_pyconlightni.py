...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PyConTalkProposal.perceived_value'
        db.alter_column(u'pycon_pycontalkproposal', 'perceived_value', self.gf('django.db.models.fields.TextField')(max_length=400))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'PyConTalkProposal.perceived_value'
        db.alter_column(u'pycon_pycontalkproposal', 'perceived_value', self.gf('django.db.models.fields.TextField')(max_length=500))
