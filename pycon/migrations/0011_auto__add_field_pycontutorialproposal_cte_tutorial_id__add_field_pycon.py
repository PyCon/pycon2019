...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'pycon_pycontutorialproposal', 'cte_tutorial_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=150, blank=True),
                      keep_default=False)

        # Adding field 'PyConTutorialProposal.max_attendees'
        db.add_column(u'pycon_pycontutorialproposal', 'max_attendees',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PyConTutorialProposal.cte_tutorial_id'
        db.delete_column(u'pycon_pycontutorialproposal', 'cte_tutorial_id')

        # Deleting field 'PyConTutorialProposal.max_attendees'
        db.delete_column(u'pycon_pycontutorialproposal', 'max_attendees')
