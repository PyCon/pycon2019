...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sponsor.contact_phone'
        db.add_column(u'sponsorship_sponsor', 'contact_phone',
        ...
        db.add_column(u'sponsorship_sponsor', 'approval_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Sponsor.wants_table'
        db.add_column(u'sponsorship_sponsor', 'wants_table',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Sponsor.wants_booth'
        db.add_column(u'sponsorship_sponsor', 'wants_booth',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Sponsor.contact_phone'
        db.delete_column(u'sponsorship_sponsor', 'contact_phone')

        # Deleting field 'Sponsor.contact_address'
        db.delete_column(u'sponsorship_sponsor', 'contact_address')

        # Deleting field 'Sponsor.approval_time'
        db.delete_column(u'sponsorship_sponsor', 'approval_time')

        # Deleting field 'Sponsor.wants_table'
        db.delete_column(u'sponsorship_sponsor', 'wants_table')

        # Deleting field 'Sponsor.wants_booth'
        db.delete_column(u'sponsorship_sponsor', 'wants_booth')
    ...
    models = {
        ...
        u'sponsorship.sponsor': {
            ...
            'wants_booth': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'wants_table': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
