...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Review._comment_rendered'
        db.delete_column(u'reviews_review', '_comment_rendered')


        # Changing field 'Review.comment'
        db.alter_column(u'reviews_review', 'comment', self.gf('django.db.models.fields.TextField')())
        # Deleting field 'Comment._text_rendered'
        db.delete_column(u'reviews_comment', '_text_rendered')


        # Changing field 'Comment.text'
        db.alter_column(u'reviews_comment', 'text', self.gf('django.db.models.fields.TextField')())
        # Deleting field 'ProposalMessage._message_rendered'
        db.delete_column(u'reviews_proposalmessage', '_message_rendered')


        # Changing field 'ProposalMessage.message'
        db.alter_column(u'reviews_proposalmessage', 'message', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):
        # Adding field 'Review._comment_rendered'
        db.add_column(u'reviews_review', '_comment_rendered',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


        # Changing field 'Review.comment'
        db.alter_column(u'reviews_review', 'comment', self.gf('markitup.fields.MarkupField')(no_rendered_field=True))
        # Adding field 'Comment._text_rendered'
        db.add_column(u'reviews_comment', '_text_rendered',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


        # Changing field 'Comment.text'
        db.alter_column(u'reviews_comment', 'text', self.gf('markitup.fields.MarkupField')(no_rendered_field=True))
        # Adding field 'ProposalMessage._message_rendered'
        db.add_column(u'reviews_proposalmessage', '_message_rendered',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


        # Changing field 'ProposalMessage.message'
        db.alter_column(u'reviews_proposalmessage', 'message', self.gf('markitup.fields.MarkupField')(no_rendered_field=True))
