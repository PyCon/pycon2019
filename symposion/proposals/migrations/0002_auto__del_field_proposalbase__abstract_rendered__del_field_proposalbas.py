...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ProposalBase._abstract_rendered'
        db.delete_column(u'proposals_proposalbase', '_abstract_rendered')

        # Deleting field 'ProposalBase._additional_notes_rendered'
        db.delete_column(u'proposals_proposalbase', '_additional_notes_rendered')


        # Changing field 'ProposalBase.abstract'
        db.alter_column(u'proposals_proposalbase', 'abstract', self.gf('django.db.models.fields.TextField')())

        # Changing field 'ProposalBase.additional_notes'
        db.alter_column(u'proposals_proposalbase', 'additional_notes', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):
        # Adding field 'ProposalBase._abstract_rendered'
        db.add_column(u'proposals_proposalbase', '_abstract_rendered',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'ProposalBase._additional_notes_rendered'
        db.add_column(u'proposals_proposalbase', '_additional_notes_rendered',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


        # Changing field 'ProposalBase.abstract'
        db.alter_column(u'proposals_proposalbase', 'abstract', self.gf('markitup.fields.MarkupField')(no_rendered_field=True))

        # Changing field 'ProposalBase.additional_notes'
        db.alter_column(u'proposals_proposalbase', 'additional_notes', self.gf('markitup.fields.MarkupField')(no_rendered_field=True))
