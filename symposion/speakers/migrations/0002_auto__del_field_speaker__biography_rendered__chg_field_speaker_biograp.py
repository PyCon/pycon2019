...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Speaker._biography_rendered'
        db.delete_column(u'speakers_speaker', '_biography_rendered')


        # Changing field 'Speaker.biography'
        db.alter_column(u'speakers_speaker', 'biography', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):
        # Adding field 'Speaker._biography_rendered'
        db.add_column(u'speakers_speaker', '_biography_rendered',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


        # Changing field 'Speaker.biography'
        db.alter_column(u'speakers_speaker', 'biography', self.gf('markitup.fields.MarkupField')(no_rendered_field=True))
