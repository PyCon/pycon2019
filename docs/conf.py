...
project = u'Pycon Website'
copyright = u'2015, Python Software Foundation, Eldarion, and Caktus Consulting Group'
...
latex_documents = [
  ('index', 'PyCon.tex', u'PyCon Documentation',
   u'Caktus', 'manual'),
]
...
man_pages = [
    ('index', 'Pycon', u'PyCon Documentation',
     [u'Caktus'], 1)
]
...
texinfo_documents = [
  ('index', 'PyCon', u'PyCon Documentation',
   u'Caktus', 'Pycon', 'One line description of project.',
   'Miscellaneous'),
]
